...
CF   &  47\% &  27 & $-0.01$ & $-0.01$ \\
\midrule
\textbf{average} & \textbf{69\%} & \textbf{68} & \textbf{0.63} & \textbf{0.39} \\
\bottomrule
\end{tabular}
\end{center}
...
average verified buy count per year; the book totals $\approx$542 fills a year,
about 2.2 per session across the sixteen sleeves. Correlations are measured against
