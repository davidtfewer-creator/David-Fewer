...
\begin{itemize}
\item \textbf{The 200dma gate} (bear armour): no new bids in a name whose last
close sits below its trailing 200-day average; gated capital pools to the other
sleeves. In the 2022 replay it turns the book's $-21.9\%$ bear year into
$-2.6\%$; in the pooled 2024--26 loop it is approximately free. Wired
(Allocation col G); VST opened gated at adoption.
...
rule), \texttt{book\_sim.py} (pooled simulator; \texttt{gap\_exit} execution
