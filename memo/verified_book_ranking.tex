...
(Revised 14 August 2026.) The book as it stands after the GM/VLO/CF and MRVL
admissions, all figures on the verified basis:
...
end-Q1 2027). \textbf{AVGO} re-tests mid-September 2026, after its
$\approx$4~September report adds a tenth post-report window to its
pause case; the admission bar is unchanged --- the ten-name book must stop
losing to the nine-name book on the tested half.
