...
\midrule
\textbf{average / total} & \textbf{69\%} & \textbf{63\%} & \textbf{542} & \textbf{0.63} & \textbf{0.39} \\
\bottomrule
\end{tabular}
\end{center}
...
planning figures the eight-name book runs $\approx$\textbf{63\%/yr}; the measured
held construction over the sample gives 71.4\%/yr. Trades/yr is the average
verified buy count per year; the bottom row is the book's \emph{total},
$\approx$542 fills a year, about 2.2 per session across the sixteen sleeves.
