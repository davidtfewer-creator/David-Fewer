...
{\color{bcgrey} 3 August 2026}\\[1.6cm]
...
and substantial; its magnitude was overstated roughly fivefold. Seven attempts to improve the
model were tested out of sample: six failed. The single validated change is a tilt of capital
toward the Bayes sleeve.}}
\end{titlepage}
...
A separate finding deserves note as \emph{partially} supported: the calendar stop-loss period
is not well set at a uniform $50$ days. Regime-appropriate values (tighter for choppy names,
longer for momentum names such as RKLB) beat the uniform setting in $6$ of $10$ names out of
sample --- better than chance, but the \emph{direction} generalises while the specific value
does not. Round numbers by regime are defensible; fitted optima are not.

% ================= 8 =================
\section{Conclusions and recommendations}

\begin{enumerate}[leftmargin=1.5em,itemsep=3pt]
  \item \kpi{Restate expected performance.}{} Plan against $\sim\!45\%$ annualised and
        ...
        $57\%$ of the time.
  \item \kpi{Adopt a moderate Bayes tilt.}{} Move the allocation to $70\text{--}80\%$ Bayes,
        uniformly, with a $5\%$ floor on the minor sleeve. Expected benefit $\sim\!+2$pp
        annualised at no cost to trade frequency.
  \item \kpi{Leave all other parameters unchanged.}{} Six independent attempts to improve them
        failed out of sample. The edge is structural, not parametric.
