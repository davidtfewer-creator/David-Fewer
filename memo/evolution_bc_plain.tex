...
all rules live in the trading workbook, honest expectation $\approx$66\%/yr
...
outvote the judgement. The honest cost: on the same careful planning basis
the book now targets \textbf{roughly 66\% a year}, with the fuller simulation
measuring around 88\%. What we bought with those points: no binary launch
