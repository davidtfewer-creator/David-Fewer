...
{\color{bcgrey} 15 August 2026 --- gate adopted and wired the same day (\S7);\\execution-accurate restatement added 19 August (\S8)}
\vfill
\end{titlepage}
...
(breaker, price-stop and gate support); workbook wiring
\texttt{wire\_200dma.py} (re-runnable on any future copy). Findings recorded in
HANDOVER \S3.13. Companion paper: \emph{Three Volatility Overlays, Tested and
