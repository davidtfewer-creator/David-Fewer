...
{\color{bcblue}\LARGE Revision 4 --- OU Sigma Correction}\\[0.5cm]
...
{\color{bcgrey} 4 August 2026 --- Revision 4}\\[1.6cm]
...
\textbf{Revision 4 corrects the OU sleeve's uncertainty scale on the five daily names.} It was
...
\textbf{Weight}\\
\midrule
\rowcolor{bckeep} RKLB & Daily hybrid   & 134\% & 65\%  & 97\%  & 14.29\%\\
AVGO & Weekly Monday  & 91\%  & 96\%  & 60\%  & 14.29\%\\
\rowcolor{bckeep} NVDA & Weekly Monday  & 82\%  & 82\%  & 58\%  & 14.29\%\\
TSM  & Daily hybrid   & 67\%  & 89\%  & 51\%  & 14.29\%\\
\rowcolor{bckeep} VST  & Daily hybrid   & 66\%  & 55\%  & 54\%  & 14.29\%\\
VRT  & Daily hybrid   & 66\%  & 168\% & \textbf{44\%} & 14.29\%\\
\rowcolor{bckeep} MU   & Daily hybrid   & 51\%  & 124\% & 50\%  & 14.29\%\\
\midrule
\textbf{Book} & equal weight & \textbf{79\%} & --- & \textbf{59\%} & 100\%\\
\textbf{Book ex-RKLB} & & \textbf{70\%} & --- & \textbf{53\%} & \\
\bottomrule
\end{tabular}
...
floor. Daily verified figures carry the corrected OU sleeve of \S9; the planning column is
deliberately unchanged, since it rests on the 50/50 result plus the walk-forward-validated tilt
and the correction's book-level contribution has not been re-derived on that basis.}
\end{table}
...
\textbf{The sleeve split stays at 75\%.} The correction was tested against the hypothesis that
the tilt had been compensating for the mis-specification. It had not. The full-sample curve does
invert --- with the corrected sleeve it prefers 0\% Bayes --- but the walk-forward still selects
the deployed share, choosing 100\% Bayes as its median on every training window and beating 75\%
in only 8 or 9 folds of 15 by about 1.6pp. The curve's shape is regime-dependent, not stable.
