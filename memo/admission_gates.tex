...
\vspace{0.35cm}
{\large\color{bcnavy} The criteria a stock must clear to enter the eight-name book,\\
...
$\cdot$ GM $\cdot$ VLO $\cdot$ CF \;$\bullet$\; all figures on verified fills}
\end{center}
\vspace{0.1cm}
...
what the August 2026 review actually did: they admit GM, VLO and CF; they decline
NVDA, AVGO and TSLA; and they flag VST. A candidate that cannot be pushed through
...
acceptable spread against the book's $\approx$63\% planning average. GM, VLO and
